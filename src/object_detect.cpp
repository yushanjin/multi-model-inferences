...
Result ObjectDetect::OpenPresenterChannel(string channel_name) {
...
Result ObjectDetect::Init(string channel_name) {
...
Result ObjectDetect::Postprocess(cv::Mat& frame, aclmdlDataset* modelOutput){
    ...
    for (uint32_t i = 0; i < totalBox; i++) {
        ...
        printf("%d %d %d %d %s\n", oneResult.lt.x, oneResult.lt.y, oneResult.rb.x, oneResult.rb.y, oneResult.result_text.c_str());
